"""Script to write Phase 3 frontend pages."""
import os

BASE = r'c:/Users/anton/naresh-gold-store/naresh-project/frontend/src/pages'
...
with open(os.path.join(BASE, 'ContactPage.tsx'), 'w') as f:
    f.write(contact)
print('ContactPage written')

with open(os.path.join(BASE, 'AppointmentPage.tsx'), 'w') as f:
    f.write(appointment)
print('AppointmentPage written')